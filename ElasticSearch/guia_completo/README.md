...
* [4.2 - Padrão de Produção de Nós](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-4-1-f22b5ca8aa72)
...
* [5.3 - Reindex e a Copias dos Dados](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-5-2-ea7bdd6be344)
...
* [8.0 - Introdução a Agregações](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-8-98abcb4335a4?postPublishedType=initial)
* [8.1 - Casos práticos de Agregações](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-8-1-a044ec33018d)

### Capítulo 9 - Ingestão
* [9.0 - Introdução a Pipelines de Ingestão](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-9-e31362014702)
* [9.1 - Processadores de Ingestão — Set](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-9-1-6c9e30242d67)
* [9.2 - Iterando em nested objects usando o Foreach](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-9-2-d24991f7d366)

### Capítulo 10 - Analisadores
* [10.0 - Como funcionam os analisadores de texto do Elasticsearch](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-10-8e34ceb8f5a0)
* [10.1 - Introdução a Analisadores](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-10-1-d95e546eacb1)

### Capítulo 11 - Administração de Cluster
* [11.0 - API’s fundamentais para administração de Cluster](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-11-33625de341a3)
* [11.1 - Backup e Restore](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-11-1-67585d1c7715)

### Capítulo 12 - Segurança
* [12.0 - Introdução a Segurança e habilitando Basic Auth](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-12-40875483dd7e)
* [12.1 - Habilitando HTTPS](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-12-1-954b053f23e5)
* [12.2 - Gestão de Usuários](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-12-2-dce4a4ab89ab)
* [12.3 - Gestão de Papéis](https://medium.com/@fqueirooz80/elasticsearch-tudo-que-voc%C3%AA-precisa-saber-sobre-a-ferramenta-de-buscas-da-elastic-parte-12-3-980ce64b2554)
...
* [1.2 — Implementação Básica de um Pipeline](https://medium.com/@fqueirooz80/implementando-um-pipeline-no-logstash-parte-1-2-implementa%C3%A7%C3%A3o-b%C3%A1sica-7ac0664876ba)
* [1.3 — Como configurar a instância de Logstash para múltiplos pipelines](https://medium.com/@fqueirooz80/implementando-um-pipeline-no-logstash-parte-1-3-25c09e0d5960)

### Capítulo 2 - Plugins de Filter
* [Grok Debugger - O Plugin mais famoso - Como Processar dados não estruturados](https://medium.com/@fqueirooz80/como-processar-dados-n%C3%A3o-estruturados-utilizando-o-logstash-com-grok-debugger-b6f2edb0eafa?postPublishedType=initial)
...
* [Observabilidade em 1h - Conteúdo do Elastic Virtual Week Dia 02](https://techlipe.github.io/Workshop-Zero-To-Hero/dia02-observabilidade)

### Métricas

* [Introdução justa e prática ao Metricbeat](https://medium.com/@fqueirooz80/um-entendimento-justo-e-pr%C3%A1tico-dos-beats-da-elastic-metricbeat-parte-2-2206646ef21c)

### Arquivos/Logs
* [Introdução justa e prática ao Filebeat](https://medium.com/@fqueirooz80/um-entendimento-justo-e-pr%C3%A1tico-dos-beats-da-elastic-introdu%C3%A7%C3%A3o-e-filebeat-parte-1-c93e8efa3a53)

### Serviços
* [Introdução justa e prática ao Heartbeat](https://medium.com/@fqueirooz80/um-entendimento-justo-e-pr%C3%A1tico-dos-beats-da-elastic-heartbeat-parte-3-2c71dbb8c9a3)



Creditos/Fonte ==> https://github.com/techlipe/Guia-Completo-Elastic-Stack